...
export const mockTransactions: Transaction[] = [
  ...
  { id: 'txn-1', accountId: 'acc-1', date: new Date(new Date().setDate(new Date().getDate() - 1)).toISOString(), description: 'Grocery Store', amount: -75.50, type: 'Withdrawal' },
  ...
  { id: 'txn-3', accountId: 'acc-1', date: new Date(new Date().setDate(new Date().getDate() - 3)).toISOString(), description: 'Gas Station', amount: -45.00, type: 'Withdrawal' },
  { id: 'txn-4', accountId: 'acc-1', date: new Date(new Date().setDate(new Date().getDate() - 5)).toISOString(), description: 'Online Shopping', amount: -210.20, type: 'Withdrawal' },
  { id: 'txn-5', accountId: 'acc-1', date: new Date(new Date().setDate(new Date().getDate() - 7)).toISOString(), description: 'Restaurant', amount: -60.00, type: 'Withdrawal' },
  ...
  { id: 'txn-11', accountId: 'acc-1', date: new Date(new Date().setDate(new Date().getDate() - 32)).toISOString(), description: 'Old Utility Bill', amount: -120.00, type: 'Withdrawal' },
